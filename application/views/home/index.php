        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="<?=base_url('assets/img/wahyudin.jpg')?>" alt="">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="<?=base_url('assets/img/addina.png')?>" alt="">
                            <div class="team-overlay position-absolute start-0 top-0 w-100 h-100">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="<?=base_url('assets/img/jundi.png')?>" alt="">
                            <div class="team-overlay position-absolute start-0 top-0 w-100 h-100">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="<?=base_url('assets/img/cahyo.jpg')?>" alt="">
                            <div class="team-overlay position-absolute start-0 top-0 w-100 h-100">
                                <a class="btn btn-square mx-1" href="https://www.linkedin.com/in/putra-prayoga-7b3838227/"><i class="fab fa-linkedin-in"></i></a>
                                <a class="btn btn-square mx-1" href="https://www.instagram.com/00puts88/"><i class="fab fa-instagram"></i></a>
                            </div>
                        ...
                        <div class="bg-light text-center p-4">
                            <h5 class="fw-bold mb-0">Cahyo</h5>
                            <small>Teknisi II</small>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        ...
                        Distributed By : <a class="border-bottom" href="https://themewagon.com" target="_blank">4TI-06 || Jaminan Kualitas Perangkat Lunak</a>
                    </div>
